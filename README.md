# ocaml-cordova-plugin-file-example

This is an example of the binding to the *file cordova plugin*. See the
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-file
  for this project.
